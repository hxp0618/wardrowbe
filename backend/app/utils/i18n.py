...
MESSAGES_ZH: dict[str, str] = {
    ...
    "error.weather_location_not_found": "无法解析位置「{location}」，请换一个城市名称或使用当前位置。",
...
MESSAGES_EN: dict[str, str] = {
    ...
    "error.weather_location_not_found": "Could not resolve location \"{location}\". Try another city name or use current location.",
